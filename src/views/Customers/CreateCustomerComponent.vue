            ...
            <div class="accordion mb-4">
              ...
              <div class="accordion-item border-0 shadow-sm">
                <h5 class="accordion-header bg-gradient-success d-flex justify-content-between align-items-center py-3 px-2 bg-light rounded-top"
                    :class="{'accordion-open': accordion.customerDetails}"
                    @click="toggleAccordion('customerDetails')"
              ...
              <div class="accordion-item border-0 shadow-sm mt-2">
                <h5 class="accordion-header bg-gradient-success d-flex justify-content-between align-items-center py-3 px-2 bg-light rounded-top"
                    :class="{'accordion-open': accordion.customerDocuments}"
                    @click="toggleAccordion('customerDocuments')"
                    style="cursor:pointer;">
                  <span>
                  ...
                  <div class="accordion-content bg-white px-3 py-3">
                    <div class="row">
                      <CustomerDocuments ref="customerDocsComponent" />
                    </div>
                  </div>
...
import { createCustomer } from "@/utils/customer_services";
import showSwal from "@/mixins/showSwal.js";
import PulseLoader from "../PulseLoader.vue";
// import EditViewCustomerComponent from "../Customers/EditViewCustomerComponent.vue";
import {  mapMutations, mapState } from "vuex";
import OffCanvas from "@/components/OffCanvas.vue";
import CustomerDocuments from './CustomerDocuments.vue'

export default {
    name: "ViewCreateEditCustomerComponent",
    components: {
        MaterialInput,
        MaterialButton,
        AppFormNew,
    ...
    methods: {
        ...
        async handleSubmit(values) {
            ...
            if (this.$refs.customerDocsComponent) {
                // 2. Call the getDocuments() method from the child component.
                const documentsToUpload = this.$refs.customerDocsComponent.getDocuments();
