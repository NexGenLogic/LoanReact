<template>
    <form @submit.prevent="submit" class="popup-form">
        <div class="mb-3">
            <label class="label-main">Investment Amount</label>
            <input
                type="number"
                class="input-main"
        ...
        <div class="mb-3">
            <label class="label-main">Date of Investment</label>
            <input
                type="date"
                class="input-main"
...
export default {
    ...
    data() {
        return {
            investmentAmount: "",
            investmentDate: new Date().toISOString().substr(0, 10),
            paymentMethod: "cash",
            referenceNo: "",
            // --- NEW DATA PROPERTY ---
    ...
    methods: {
        ...
        submit() {
            if (this.validate()) {
                ...
                formData.append('amount', Number(this.investmentAmount));
                formData.append('payment_date', this.investmentDate);
