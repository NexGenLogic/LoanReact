                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 mx-auto " style="margin-top: 200px;">
                        <div class="card mt-8">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div
                                    class="bg-success shadow-warning border-radius-lg py-3 pe-1 text-center py-4">
                            ...
                            <div class="py-4 card-body">
                                <AppForm role="form" :validation-schema="schema" @submit="handleReset">
                                    <div class="mb-3">
