                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5"
                                ...
                                <div class="card card-plain">
                                    ...
                                    <div class="card-body mr-mobile-200">
                                            ...
                                            <fieldset v-if="step === 1">
                                                ...
                                                <div class="mb-3">
                                                    <material-input-field id="merchant_postalcode"
                                                        ...
                                                        label="Merchant postal code" name="merchant_postalcode"
                                                        variant="static" />
                                                </div>
                                                <div class="mb-6">
                                            ...
                                            <fieldset v-if="step === 4"> -->
                                                ...
                                                <material-checkbox-field id="flexCheckDefault"
                                                    ...
                                                    <router-link :to="{ name: 'Terms Conditions' }"
                                                        class="text-success text-gradient font-weight-bold">Terms and
                                                        conditions</router-link>
                                                </material-checkbox-field>
                                                <div id="error_reg" v-html="errorHtml"
                                                    style="display: flex;flex-direction: column;align-items: end;font-style:italic">
                                                </div>
                                                <!-- Submit Button -->
                                                <div class="text-center"
                                                    ...
                                                    <material-button type="button" @click="validateStepOne"
                                                        class="my-4 mb-2" variant="gradient"
                                                        :color="isRegistering ? 'dark' : 'success'" full-width
                                                        :disabled="isRegistering">
                                                        <span v-if="!isRegistering">Register</span>
                                                        <span v-else>
                                                            <i class="fa fa-spinner fa-spin me-1"></i> Signing up...
                                                        </span>
                                                    </material-button>
                                                </div>
                                            </fieldset>
                                    ...
                                    <div class="px-1 pt-0 text-center card-footer px-lg-2 mr-mobile-200">
...
export default {
    ...
    methods: {
        ...
        async handleSignup() {
            ...
            payload.append('address_same_as_merchant', 1);
...
@media (max-width: 576px) {
    ...
    /* Bootstrap "xs" breakpoint for mobile */
    .mr-mobile-200 {
