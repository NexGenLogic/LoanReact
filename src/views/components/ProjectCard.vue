      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-5 my-auto text-end">
          <div class="dropdown float-lg-end pe-4">
            ...
            >
              <li>
                <a class="dropdown-item border-radius-md" href="javascript:;" @click="goToLoanPage">
                  View All
                </a>
              </li>
              <!-- <li>
...
export default {
  ...
  methods: {
    goToLoan(project) {
    const loanId = project.id; // Use the right field if different
    this.$router.push({ name: 'Loan Edit', params: { loanId } });
  },
  goToLoanPage() {
    this.$router.push({ name: 'Loans' }); 
    // or path: '/loan' if route configured with path '/loan'
  }
  }
};
</script>
